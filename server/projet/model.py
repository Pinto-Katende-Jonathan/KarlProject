...
class Enseignant(db.Model):
    ...
    prestations = db.relationship('Prestation', backref='enseignant')#1 to many
...
class Prestation(db.Model):
    ...
    enseignant_id = db.Column(db.Integer, db.ForeignKey('enseignant.id'), nullable=False)#child
    cours_id = db.Column(db.Integer, db.ForeignKey('cours.id'), nullable=False)#child
...
class Paiement (db.Model):
    ...
    prestation_id = db.Column(db.Integer, db.ForeignKey('prestation.id'), unique=True, nullable=False)#child
